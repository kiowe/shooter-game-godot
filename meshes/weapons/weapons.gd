...
@export_category("Weapon Orientaion")
@export var position : Vector3
@export var rotation : Vector3
@export var scale : Vector3
@export_category("Weapon Sway")
@export var sway_min : Vector2 = Vector2(-30.0, -30.0)
@export var sway_max : Vector2 = Vector2(350.0, 30.0)
...
@export_range(0, 50.0, 0.1) var sway_amount_rotation : float = 30
